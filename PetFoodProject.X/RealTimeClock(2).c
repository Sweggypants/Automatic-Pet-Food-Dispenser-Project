...
void main(void)   //------------ Main Program  ---------------------------------------------------------------
{
	...
	___________;  //Fill in the function that setup the time.
	________________;  //Fill in the function that setup the alarm time.
	______________________________;  //Fill in the function that setup the timer interrupt registers
					 //and switch on the timer as well.
	...
	while(1)
	{
		if(hour==hourA && minute==minuteA)
		{
			if(displayUpdated == 2)
			{
				________________;  //Fill in the function that display 'Alarm On' on LCD.
				displayUpdated = 1;
			}
		}
		else
		{
			if(displayUpdated == 1)
			{
				________________;  //Fill in the function that display 'Alarm Off' on LCD.
				displayUpdated = 2;
			}
		}
	}
