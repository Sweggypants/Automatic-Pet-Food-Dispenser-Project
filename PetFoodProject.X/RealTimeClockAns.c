...
void SetupTime()
{
	...
	unsigned char hour10, hour1, minute10, minute1, second10, second1;
	char Message[ ] = "Set time HH/MM/SS           :    ";
...
void SetupAlarmTime()
{
	...
	char Message[ ] = "Set time to dispense         :";
...
void turnServoMotor()
{
    ...
    delay_ms(1.5); // delay for 1.5 ms i.e. pulse width (12 oClock)
    PORTAbits.RA0 = 0; // RA0 low
    delay_ms(18.5); // delay for 18.5 ms i.e. low time
    }
    delay_ms(1000);
    for (count = 0; count < 13; count++)
    {
    PORTAbits.RA0 = 1; // RA0 high
    delay_ms(2.4); // delay for 1.5 ms i.e. pulse width (9 oClock)
    PORTAbits.RA0 = 0; // RA0 low
    delay_ms(17.6); // delay for 18.5 ms i.e. low time
    }
    delay_ms(1000);
    for (count = 0; count < 13; count++)
    {
